...
ALL_SKILL_DEFS = {
    ...
    'roll_strike': {   # 석궁 마스터 전용 — 구르기 회피 후 다음 공격 확정 치명타+기절
        ...
        'color': (255, 200, 80),
        'category': 'mobility',
        'desc': '재빠르게 구르며 스치는 적을 베고, 다음 공격이 확정 치명타 + 대상 기절',
        'desc_en': 'Quickly roll, slashing anything in your path, then your next attack is a guaranteed crit that stuns',
        'desc_ja': '素早く転がり道中の敵を斬りつけ、次の攻撃が確定クリティカル＋対象を気絶',
        'desc_zh': '快速翻滚并斩击沿途敌人，下一次攻击必定暴击并眩晕目标',
        'desc_ru': 'Быстрый перекат разит врагов на пути — следующая атака гарант. крит и оглушает',
        'usage': '이동 방향으로 N칸 회피 구르기(스친 적 즉시 타격) · 다음 공격 확정 치명타+기절',
        'usage_en': 'Roll N tiles, striking anything you pass · next attack guaranteed crit + stun',
        'usage_ja': 'N マス回避転がり(道中の敵を即座に攻撃) · 次の攻撃 確定クリティカル+気絶',
        'usage_zh': '翻滚 N 格(立即打击沿途敌人) · 下一击必定暴击+眩晕',
        'usage_ru': 'Перекат на N клеток (бьёт всех на пути) · след. атака крит + оглушение',
        'upgrades': [
            {'tiles': 3, 'primed_ms': 3000, 'stun_ms': 1200, 'cd_ms': 4000,
             'level_desc': '3칸 구르기 · 기절 1.2초 · 쿨 4.0초',
             'level_desc_en': '3-tile roll · 1.2s stun · 4.0s CD',
             'level_desc_ja': '3マス転がり · 気絶1.2秒 · CD4.0秒',
             'level_desc_zh': '翻滚3格 · 眩晕1.2秒 · 冷却4.0秒',
             'level_desc_ru': 'Перекат 3 кл. · оглуш. 1,2с · КД 4,0с'},
            {'tiles': 4, 'primed_ms': 3500, 'stun_ms': 1500, 'cd_ms': 3500,
             'level_desc': '4칸 구르기 · 기절 1.5초 · 쿨 3.5초',
             'level_desc_en': '4-tile roll · 1.5s stun · 3.5s CD',
             'level_desc_ja': '4マス転がり · 気絶1.5秒 · CD3.5秒',
             'level_desc_zh': '翻滚4格 · 眩晕1.5秒 · 冷却3.5秒',
             'level_desc_ru': 'Перекат 4 кл. · оглуш. 1,5с · КД 3,5с'},
            {'tiles': 5, 'primed_ms': 4000, 'stun_ms': 1800, 'cd_ms': 3000,
             'level_desc': '5칸 구르기 · 기절 1.8초 · 쿨 3.0초',
             'level_desc_en': '5-tile roll · 1.8s stun · 3.0s CD',
             'level_desc_ja': '5マス転がり · 気絶1.8秒 · CD3.0秒',
             'level_desc_zh': '翻滚5格 · 眩晕1.8秒 · 冷却3.0秒',
             'level_desc_ru': 'Перекат 5 кл. · оглуш. 1,8с · КД 3,0с'},
        ],
        'sp_cost': [5, 10],
    },
    'elemental_burst': {   # 마검사 전용 — 주변 랜덤 원소 폭발(번개/불/물/바람)
        ...
        'color': (200, 130, 250),
        'category': 'attack',
        'desc': '주변에 랜덤 원소(번개/불/물/바람) 폭발을 여러 번 일으켜 광역 피해',
        'desc_en': 'Trigger random elemental blasts (lightning/fire/water/wind) around you',
        'desc_ja': '周囲にランダム元素(雷/火/水/風)の爆発を複数起こす',
        'desc_zh': '在周围引发多次随机元素(雷/火/水/风)爆发',
        'desc_ru': 'Случайные взрывы стихий (молния/огонь/вода/ветер) вокруг вас',
        'usage': '반경 N칸 내 랜덤 지점에 M회 원소 폭발 · 원소별 부가효과',
        'usage_en': 'M elemental blasts at random spots within radius N · elemental effects',
        'usage_ja': '半径Nマス内のランダム地点でM回爆発 · 元素効果',
        'usage_zh': '半径N格内随机地点爆发M次 · 元素效果',
        'usage_ru': 'M взрывов в случайных точках в радиусе N · эффекты стихий',
        'upgrades': [
            {'radius': 2, 'bursts': 3, 'mul': 0.9, 'cd_ms': 5000,
             'level_desc': '반경 2 · 3회 폭발 · 90% 피해',
             'level_desc_en': 'Radius 2 · 3 blasts · 90% DMG',
             'level_desc_ja': '半径2 · 3回爆発 · 90%ダメージ',
             'level_desc_zh': '半径2 · 爆发3次 · 90%伤害',
             'level_desc_ru': 'Радиус 2 · 3 взрыва · 90% урона'},
            {'radius': 2, 'bursts': 4, 'mul': 1.0, 'cd_ms': 4500,
             'level_desc': '반경 2 · 4회 폭발 · 100% 피해',
             'level_desc_en': 'Radius 2 · 4 blasts · 100% DMG',
             'level_desc_ja': '半径2 · 4回爆発 · 100%ダメージ',
             'level_desc_zh': '半径2 · 爆发4次 · 100%伤害',
             'level_desc_ru': 'Радиус 2 · 4 взрыва · 100% урона'},
            {'radius': 3, 'bursts': 5, 'mul': 1.1, 'cd_ms': 4000,
             'level_desc': '반경 3 · 5회 폭발 · 110% 피해',
             'level_desc_en': 'Radius 3 · 5 blasts · 110% DMG',
             'level_desc_ja': '半径3 · 5回爆発 · 110%ダメージ',
             'level_desc_zh': '半径3 · 爆发5次 · 110%伤害',
             'level_desc_ru': 'Радиус 3 · 5 взрывов · 110% урона'},
        ],
        'sp_cost': [8, 14],
    },
    'arcane_barrage': {   # 스피드 마법사 전용 — 전방 마법 볼트 초고속 연발
        ...
        'color': (120, 190, 255),
        'category': 'attack',
        'desc': '전방으로 마법 볼트를 초고속으로 연발 발사',
        'desc_en': 'Fire a rapid volley of magic bolts forward',
        'desc_ja': '前方へ魔法弾を高速で連射',
        'desc_zh': '向前高速连射魔法弹',
        'desc_ru': 'Быстрый залп магических снарядов вперёд',
        'usage': '전방으로 N발 산탄 볼트 연발',
        'usage_en': 'Rapid-fire N spread bolts forward',
        'usage_ja': '前方へN発の散弾ボルトを連射',
        'usage_zh': '向前连射N发散射弹',
        'usage_ru': 'Скорострельные N снарядов веером вперёд',
        'upgrades': [
            {'shots': 4, 'range': 6, 'mul': 0.55, 'cd_ms': 4000,
             'level_desc': '4연발 · 사거리 6 · 발당 55%',
             'level_desc_en': '4 shots · range 6 · 55% each',
             'level_desc_ja': '4連射 · 射程6 · 各55%',
             'level_desc_zh': '4连发 · 射程6 · 每发55%',
             'level_desc_ru': '4 выстрела · дальн. 6 · 55% каждый'},
            {'shots': 5, 'range': 7, 'mul': 0.6, 'cd_ms': 3500,
             'level_desc': '5연발 · 사거리 7 · 발당 60%',
             'level_desc_en': '5 shots · range 7 · 60% each',
             'level_desc_ja': '5連射 · 射程7 · 各60%',
             'level_desc_zh': '5连发 · 射程7 · 每发60%',
             'level_desc_ru': '5 выстрелов · дальн. 7 · 60% каждый'},
            {'shots': 6, 'range': 8, 'mul': 0.65, 'cd_ms': 3000,
             'level_desc': '6연발 · 사거리 8 · 발당 65%',
             'level_desc_en': '6 shots · range 8 · 65% each',
             'level_desc_ja': '6連射 · 射程8 · 各65%',
             'level_desc_zh': '6连发 · 射程8 · 每发65%',
             'level_desc_ru': '6 выстрелов · дальн. 8 · 65% каждый'},
        ],
        'sp_cost': [7, 12],
    },
    'steel_whirl': {
...
_R_ULT_OVERRIDE = localize_defs({
    'warrior': {
        ...
        'color': (255, 150, 60),
        'desc': '15초간 SP 소모 대폭 감소 — 스킬을 마음껏 굴린다(완전 무료는 아님)',
        'desc_en': '15s of drastically reduced SP cost — chain skills freely (not fully free)',
        'desc_ja': '15秒間SP消費が大幅減少 — スキルを気兼ねなく — (完全無料ではない)',
        'desc_zh': '15秒内SP消耗大幅降低——尽情连发技能(并非完全免费)',
