...
ALL_SKILL_DEFS = {
    ...
    'roll_strike': {   # 석궁 마스터 전용 — 구르기 회피 후 다음 공격 확정 치명타+기절
        ...
        'color': (255, 200, 80),
        'category': 'mobility',
        'desc': '재빠르게 구른 뒤, 다음 공격이 확정 치명타 + 대상 기절',
        'desc_en': 'Quickly roll, then your next attack is a guaranteed crit that stuns',
        'desc_ja': '素早く転がり、次の攻撃が確定クリティカル＋対象を気絶',
        'desc_zh': '快速翻滚，下一次攻击必定暴击并眩晕目标',
        'desc_ru': 'Быстрый перекат — следующая атака гарант. крит и оглушает',
        'usage': '이동 방향으로 N칸 회피 구르기 · 다음 공격 확정 치명타+기절',
        'usage_en': 'Roll N tiles · next attack guaranteed crit + stun',
        'usage_ja': 'N マス回避転がり · 次の攻撃 確定クリティカル+気絶',
        'usage_zh': '翻滚 N 格 · 下一击必定暴击+眩晕',
        'usage_ru': 'Перекат на N клеток · след. атака крит + оглушение',
        'upgrades': [
