...
ALL_SKILL_DEFS = {
    ...
    'blood_rage': {   # 광전사 전용 — berserk 변형: 잃은 HP 비례로 공격력·흡혈 폭증
        'name': '피의 격노', 'name_en': 'Blood Rage', 'name_ja': '血の激昂',
        'name_zh': '血怒', 'name_ru': 'Кровавая ярость',
        'slot_default': None,
        'level_req': 1,
        'cooldown_ms': 12000,
        'color': (200, 40, 40),
        'category': 'attack',
        'desc': '광폭화하되, 잃은 HP가 많을수록 공격력과 흡혈이 폭증한다 — 위험할수록 강해진다',
        'desc_en': 'Go berserk — the more HP you are missing, the more your attack and lifesteal surge. The closer to death, the deadlier',
        'desc_ja': '狂化する — 失ったHPが多いほど攻撃力と吸血が急増。死に近いほど強い',
        'desc_zh': '狂暴 — 失去的HP越多，攻击力与吸血越暴涨。越濒死越强',
        'desc_ru': 'Впасть в ярость — чем меньше HP, тем сильнее атака и вампиризм. На грани смерти — смертоноснее всего',
        'usage': 'N초간 공속↑ + 흡혈 + 공격력↑ (잃은 HP 비례로 공격·흡혈 추가 폭증)',
        'usage_en': 'N s of ATK speed↑ + lifesteal + ATK↑ (bonus scales with missing HP)',
        'usage_ja': 'N秒 攻速↑ + 吸血 + 攻撃↑ (失ったHPに比例して急増)',
        'usage_zh': 'N秒 攻速↑ + 吸血 + 攻击↑ (随失去HP比例暴涨)',
        'usage_ru': 'N с: скор.атк↑ + вампиризм + АТК↑ (бонус растёт с потерей HP)',
        'upgrades': [
            {'aspd_pct': 0.5, 'lifesteal_pct': 0.15, 'atk_pct': 0.15,
             'rage_atk': 0.60, 'rage_ls': 0.35, 'dur_ms': 6000, 'cd_ms': 12000,
             'level_desc': '공속+50% · 흡혈15%+ · 공격+15%+ · 6초 (잃은HP비례↑)',
             'level_desc_en': 'AS+50% · LS15%+ · ATK+15%+ · 6s (scales w/ missing HP)',
             'level_desc_ja': '攻速+50% · 吸血15%+ · 攻撃+15%+ · 6秒 (失HP比例↑)',
             'level_desc_zh': '攻速+50% · 吸血15%+ · 攻击+15%+ · 6秒 (随失血↑)',
             'level_desc_ru': 'СА+50% · ВП15%+ · АТК+15%+ · 6с (растёт с потерей HP)'},
            {'aspd_pct': 0.7, 'lifesteal_pct': 0.18, 'atk_pct': 0.20,
             'rage_atk': 0.80, 'rage_ls': 0.45, 'dur_ms': 7000, 'cd_ms': 11000,
             'level_desc': '공속+70% · 흡혈18%+ · 공격+20%+ · 7초 (잃은HP비례↑↑)',
             'level_desc_en': 'AS+70% · LS18%+ · ATK+20%+ · 7s (scales w/ missing HP)',
             'level_desc_ja': '攻速+70% · 吸血18%+ · 攻撃+20%+ · 7秒 (失HP比例↑↑)',
             'level_desc_zh': '攻速+70% · 吸血18%+ · 攻击+20%+ · 7秒 (随失血↑↑)',
             'level_desc_ru': 'СА+70% · ВП18%+ · АТК+20%+ · 7с (растёт с потерей HP)'},
            {'aspd_pct': 0.9, 'lifesteal_pct': 0.22, 'atk_pct': 0.25,
             'rage_atk': 1.00, 'rage_ls': 0.55, 'dur_ms': 8000, 'cd_ms': 10000,
             'level_desc': '공속+90% · 흡혈22%+ · 공격+25%+ · 8초 (빈사 시 최대 폭증)',
             'level_desc_en': 'AS+90% · LS22%+ · ATK+25%+ · 8s (max surge near death)',
             'level_desc_ja': '攻速+90% · 吸血22%+ · 攻撃+25%+ · 8秒 (瀕死で最大)',
             'level_desc_zh': '攻速+90% · 吸血22%+ · 攻击+25%+ · 8秒 (濒死时最大)',
             'level_desc_ru': 'СА+90% · ВП22%+ · АТК+25%+ · 8с (макс. на грани смерти)'},
        ],
        'sp_cost': [6, 12],
    },
    'cyclone': {   # 폭풍 도끼 전용 — steel_whirl 확장: 광역 회전 + 사방 도끼 방사
        'name': '사이클론', 'name_en': 'Cyclone', 'name_ja': 'サイクロン',
        'name_zh': '旋风斩', 'name_ru': 'Циклон',
        'slot_default': None,
        'level_req': 10,
        'cooldown_ms': 5000,
        'color': (255, 200, 80),
        'category': 'attack',
        'desc': '거세게 회전하며 주변을 휩쓸고, 동시에 사방으로 도끼를 방사한다 — 스웜 청소',
        'desc_en': 'Spin ferociously, sweeping everything around you while hurling axes in every direction — swarm clear',
        'desc_ja': '激しく回転して周囲を薙ぎ払い、同時に八方へ斧を放つ — 群れ一掃',
        'desc_zh': '猛烈旋转横扫周围，同时向八方投掷斧头 — 清群',
        'desc_ru': 'Яростное вращение сметает всё вокруг, разбрасывая топоры во все стороны — расчистка толпы',
        'usage': '반경 R 광역 회전 타격 + 8방향 N칸 도끼 방사',
        'usage_en': 'Radius-R spin AoE + axes hurled N tiles in 8 directions',
        'usage_ja': '半径R範囲回転 + 8方向Nマス斧投射',
        'usage_zh': '半径R范围旋转 + 8方向N格投斧',
        'usage_ru': 'Вихрь радиусом R + топоры на N клеток в 8 направлениях',
        'upgrades': [
            {'radius': 2, 'mul': 1.1, 'throw_range': 4, 'throw_mul': 0.8, 'cd_ms': 5000,
             'level_desc': '반경2 · 110% · 도끼 4칸 80%',
             'level_desc_en': 'R2 · 110% · axes 4-tile 80%',
             'level_desc_ja': '半径2 · 110% · 斧4マス80%',
             'level_desc_zh': '半径2 · 110% · 斧4格80%',
             'level_desc_ru': 'R2 · 110% · топоры 4кл 80%'},
            {'radius': 2, 'mul': 1.3, 'throw_range': 5, 'throw_mul': 0.9, 'cd_ms': 4500,
             'level_desc': '반경2 · 130% · 도끼 5칸 90%',
             'level_desc_en': 'R2 · 130% · axes 5-tile 90%',
             'level_desc_ja': '半径2 · 130% · 斧5マス90%',
             'level_desc_zh': '半径2 · 130% · 斧5格90%',
             'level_desc_ru': 'R2 · 130% · топоры 5кл 90%'},
            {'radius': 3, 'mul': 1.5, 'throw_range': 6, 'throw_mul': 1.0, 'cd_ms': 4000,
             'level_desc': '반경3 · 150% · 도끼 6칸 100%',
             'level_desc_en': 'R3 · 150% · axes 6-tile 100%',
             'level_desc_ja': '半径3 · 150% · 斧6マス100%',
             'level_desc_zh': '半径3 · 150% · 斧6格100%',
             'level_desc_ru': 'R3 · 150% · топоры 6кл 100%'},
        ],
        'sp_cost': [6, 12],
    },
}
