...
_T: dict[str, dict[str, str]] = {
    ...
    'char_create_hint': {'ko': '←→ 직업   문자 입력: 이름   Enter 생성   ESC 취소',
                         'en': '←→ Class   Type: name   Enter Create   ESC Cancel',
                         'ja': '←→ 職業   入力: 名前   Enter 作成   ESC キャンセル',
                         'zh': '←→ 职业   输入: 名字   Enter 创建   ESC 取消',
                         'ru': '←→ Класс   Ввод: имя   Enter Создать   ESC Отмена'},
