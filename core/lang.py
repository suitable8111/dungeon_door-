...
_T: dict[str, dict[str, str]] = {
    ...
    'menu_mp_soon':  {'ko': '곧 지원됩니다 (beta)', 'en': 'Coming soon (beta)',
                      ...
                      'ru': 'Скоро (beta)'},
    'menu_mp_ip':    {'ko': '호스트 IP', 'en': 'Host IP', 'ja': 'ホストIP',
                      'zh': '主机IP', 'ru': 'IP хоста'},
    'menu_mp_ip_hint': {'ko': '숫자·점 입력 (예: 127.0.0.1)',
                        'en': 'Type digits/dots (e.g. 127.0.0.1)',
                        'ja': '数字・ドット入力 (例: 127.0.0.1)',
                        'zh': '输入数字和点 (例: 127.0.0.1)',
                        'ru': 'Цифры/точки (напр. 127.0.0.1)'},
